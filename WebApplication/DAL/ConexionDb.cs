...
namespace DAL
{
    ...
    public class ConexionDb
    {
        ...
        public ConexionDb()
        {
            ...
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["MensajesDb"].ConnectionString);//ConfigurationManager.ConnectionStrings["MensajesDb"].ConnectionString);
            Cmd = new SqlCommand();
        }
